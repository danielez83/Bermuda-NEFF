...
% the Craig-Gordon model (for 2H/dD) using the Merlivat and Jouzel 1979
% formualtion (eq. 9)
...
% % MJ79 VERSION
function CG_dE_2_MJ79 = CG_dE_2_MJ79(RH, T_air, dD_atmos, T_water, dD_water, kVal)
    ...
    dD_atmos   = dD_atmos/1000;
    dD_water   = dD_water/1000;
    kVal        = kVal/1000;
    ...
    alpha2_VL = 1./alpha2_LV(T_water);

    CG_dE_2_MJ79 = (((1-kVal).*((1+dD_water).*alpha2_VL - h.*(1+dD_atmos))./one_minus_h)-1).*1e3;
